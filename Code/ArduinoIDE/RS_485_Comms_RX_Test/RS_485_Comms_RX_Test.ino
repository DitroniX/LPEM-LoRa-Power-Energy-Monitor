/*
  ...
  Example Code, to demonstrate and test the LPEM, TWO UART Ports Basic Test.   0 as Terminal UART and 1 as RS485 UART in RX Mode
  ...
  * Wiring A to A and B to B
    ...
    * Use the 'RS485 RX' Code Example on another LPEM
